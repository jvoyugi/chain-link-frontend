     ...
     return (
         <div className="col-md-4 col-lg-4 mb-3 text-center  ">
             <div className="box_border col-lg-9 p-3 pt-4 m-auto rounded border-data shadow">
                 ...
                 <p className="my-2 solution_title">{props.scardtitle}</p>
    ...
    return (
        <>
            ...
            <div className="container mx-auto py-5">
                    ...
                    <div className="row d-sm-flex align-items-stretch justify-content-between BottomSectionRow" style={rowStyle}>
                        {
                            Data.map((val, ind) => {
